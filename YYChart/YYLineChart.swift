...
class YYLineChart: UIView {
    ...
    func setYLabels(yLabels:NSArray){
        var max:Int = 0
        for valueString:AnyObject in yLabels {
    ...
    func strokeChart(){
        ...
        var firstValue = Float(self.yValues!.objectAtIndex(0) as NSNumber)
        ...
        if self.strokeColor {
            ...
            self.chartLine!.strokeColor = YYColors.PNGreen.CGColor
        }
